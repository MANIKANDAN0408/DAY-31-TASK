...
const Student = () => {
    ...
    return (
        ...
        <Select
          ...
          labelId="demo-simple-select-label" sx={{ m: 2, minWidth: 119 }}
        ...
        ><br/>
          ...
          <MenuItem value="Javascript">MY Sql</MenuItem>
          <MenuItem value="Javascript">Mongo DB</MenuItem>
        </Select>
        <br/>
             ...
             <h1>STUDENTS DATA</h1> 
            {
                 ...
                 <Table sx={{ minWidth: 499 }} aria-label="customized table">
                   ...
                   <TableBody>
                     {student.map((row) => (
                       ...
                       <StyledTableRow key={row.id}>
                         ...
                         <Button variant="contained" color="success" style={{margin:"11px"}} onClick={()=>onpop(row.id)}>Edit</Button>
